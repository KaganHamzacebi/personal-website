...
const HomeScripts: IHomeScripts = {
    ...
    description:
        'I am Kağan Hamzaçebi and here is my personal playground, blog and portfolio website.\n' +
        '                    I will demonstrate my experience and projects here. Welcome and feel free to contact!',
    keywords:
        'Kağan, Kagan, Hamzacebi, Hamzaçebi, Personal, Website, Portfolio, Blog, Fullstack, Web, Developer',
    skills_h1: 'My Skills',
