...
const ProjectsSectionScripts = {
  ...
  tetherer: {
    ...
    modal: {
      ...
      date: 'January 2020',
      paragraph: 'Tetherer is basically a Discord Bot with web interface. It is used for creating customizable events for discord guilds ' + 'via website. You can create an event on your discord guild and people in your discord guild can join the event. The main working flow was like that. ' + 'We developed this project with my friend but could not finish yet and gave break for long time. The frontend of this ' + 'project is developed with ReactJS, backend is developed with Node.JS and MongoDB used for database. On frontend we preferred using ' + 'TailwindCSS, React-Router-Dom, Swiper, Axios, React-Cookie and Moment as core frameworks. On backend we used Express Server, Mongoose, DiscordJS, Moment, Axios and Cors. ' + 'We were planning to make premium features and give exclusive benefits to premium features. Maybe we complete it later.',
      slides: [
        tethererMainScreen,
        tethererMainScreen2,
        tethererMainScreen3,
      ...
      frameworks: [
        FaReact, SiTailwindcss, SiJavascript, FaNodeJs, SiTypescript, SiExpress, SiDocker, SiMongodb, SiDiscord
      ]
    }
  },
  area_violation_detection: {
    ...
    modal: {
      ...
      date: 'May 2022',
      paragraph: 'Area Violation Detection was my Deep Learning course project. The main purpose of this project is simply dynamically ' + 'detecting if the selected object is in the defined area. This functionality is built for videos. The project performance was 15 FPS ' + 'for non-CUDA supported GPUs or CPU and 30 FPS for CUDA supported GPUs. User can select up to 80 different object types and can resize and move ' + 'the dynamic area while video playing. Frontend of the project is built with PyQT5 (Python) framework. Video decoding is handled ' + 'with OpenCV. Object Detection Model was selected as YOLO. YoloV3 and YoloV5s versions implemented. Between those versions there were some ' + 'performance and detection differences. YoloV3 was faster at RTX 2070 and YoloV5s was better as detecting objects. Yolo models loaded with OpenCV and ' + 'used numpy library for some performance improvements.',
  ...
  three_in_one: {
    ...
    modal: {
      ...
      date: 'August 2022',
      paragraph: '3in1 was my capstone project and we implemented it as a 6 person team. The 3in1 name comes from the ' + 'number of modules in this project. The first module was Sleep and in this module we were showing the sleep data of the user. ' + 'The second module was chat module and in this module users can anonymously chat with each other. ' + 'The last module was VR Meditation module. As the name of the module says its implemented for meditation with VR glasses. ' + 'VR module was not available for Web though. The project was built on Web and Mobile. I worked on frontend of the web project and ' + 'built main structure of project, chat module, profile page, home page, header and footer components, login, register and forgot password pages, ' + 'api structure, helped on sleep module. Project implemented with ReactJS and TailwindCSS. Main libraries were react-router-domV6, react-hook-forms, ' + 'axios, moment, react-icons, swiper, stompjs, sockjs-client and chartjs.',
      slides: [
        threeInOneHome,
        threeInOneHome2,
        threeInOneRegister,
      ...
      frameworks: [FaReact, SiJavascript, SiTailwindcss, SiHtml5, SiCss3, SiSpring, SiAndroid, SiFirebase, SiMongodb]
    }
  },
  shop_tracker: {
    ...
    modal: {
      ...
      date: 'January 2018',
      paragraph: 'Shop Tracker is my first personal project. It was built for a food brand which sells kokoreç which is a turkish ' + 'street food. The main purpose of this application was reporting the sales of multiple branches together. Besides that application ' + 'opens with a menu to let restaurant staff use. The staff should select the sold food with the amount and type and application will show the sale ' + 'in the report section. Report section was showing the name of the staff, brand, date, total amount and food type. Report was fully filterable and ' + 'could be saved the mobile as xlss file and also the admin can have it on email. The application also had the upcoming and ready foods screen. ' + 'Customers can follow this screen and get noticed when their food is ready. The application was built with Android Native, Firebase Realtime Database and ' + 'Firebase Authentication.',
      slides: [],
