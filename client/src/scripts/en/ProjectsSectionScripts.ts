...
const ProjectsSectionScripts = {
    personal_website: {
        ...
        modal: {
            ...
            date: 'October 2022',
            paragraph:
                'My main purpose of building this website was learning new frameworks. Those new frameworks are ' +
    ...
    tetherer: {
        ...
        modal: {
            ...
            date: 'January 2020',
            paragraph:
                'Tetherer is basically a Discord Bot with web interface. It is used for creating customizable events for discord guilds ' +
    ...
    area_violation_detection: {
        ...
        description:
            'My deep learning project for detecting if the given object is violating the selected area or not.',
        modal: {
            ...
            date: 'May 2022',
            paragraph:
                'Area Violation Detection was my Deep Learning course project. The main purpose of this project is simply dynamically ' +
    ...
    three_in_one: {
        ...
        modal: {
            ...
            date: 'August 2022',
            paragraph:
                '3in1 was my capstone project and we implemented it as a 6 person team. The 3in1 name comes from the ' +
    ...
    shop_tracker: {
        ...
        description:
            'A sale tracker and detailed reporter mobile application. This app simultaneously track the multiple branches of a restaurant.',
        modal: {
            tag: 'shop_tracker',
            heading: 'Shop Tracker',
            isPrivate: false,
            ...
            date: 'January 2018',
            paragraph:
                'Shop Tracker is my first personal project. It was built for a food brand which sells kokoreç which is a turkish ' +
