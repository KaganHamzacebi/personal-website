...
function FooterSocials() {
    ...
    return (
        <div className="footerSocialsMain">
            ...
            <div className={`footerSocialsMain__bg ${theme === 'dark' ? 'dark' : 'light'}`}>
                <div
                    className={`footerSocialsMain__bg__clipboard ${theme === 'dark' ? 'dark' : 'light'} tri-right btm-left-in ${showClipboard && 'active'}`}>
                    {t.headerFooterScripts.copied}
                </div>
                <FaDiscord className={`footerSocialsMain__bg__discord ${theme === 'dark' ? 'dark' : 'light'}`}
